...
| OCR | Rust MCP local optional | `include_ocr` invokes Tesseract without a shell; missing binary/language packs are explicit gaps |
...
# OCR is local and optional; missing Tesseract is reported as available:false.
```
